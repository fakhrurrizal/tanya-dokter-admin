...
const BarChartView = () => {
    ...
    return (
        <Grid item height={'500px'} xs={12} marginTop={2} container alignItems={'center'} sx={{ marginBottom: '52px' }}>
            <Typography marginTop={1} marginBottom={2} fontWeight={600} fontSize={'16px'}>Jumlah Kunjungan</Typography>
