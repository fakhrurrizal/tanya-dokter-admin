...
const DataDrugsListPageViews = () => {
    ...
    const { data: { data: DataDrugsList = [], recordsFiltered = 0 } = { data: [] }, isLoading } =
                    ...
                    <CustomStyledTable>
                        ...
                        <tbody className='text-xs'>
                            {!isLoading &&
                                ...
                                DataDrugsList?.map((item: DataDrugsResponse['data'], index: number) => {
                                    ...
                                    return (
                                        <Fragment key={index}>
                                            <CustomStyledTableRow>
                                                ...
                                                <CustomStyledTableData>{item?.usage}</CustomStyledTableData>
