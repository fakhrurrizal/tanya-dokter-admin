...
const UserListPasienPageViews = () => {
    ...
    const { data: { data: CategoryList = [], recordsFiltered = 0 } = { data: [] }, isLoading } =
        useGetUser({
                                    ...
                                    return (
                                        <Fragment key={index}>
                                            <CustomStyledTableRow>
                                                ...
                                                <CustomStyledTableHead>{item?.email}</CustomStyledTableHead>
                                                <CustomStyledTableHead>{item?.fullname}</CustomStyledTableHead>
                                                <CustomStyledTableHead>{item?.address}</CustomStyledTableHead>
