            ...
            return (
                <Container>
                    ...
                    >
                        ...
                        <Grid item>
                            <Image width={500} height={400} alt='trouble' src='/images/trouble.svg' />
                        </Grid>

                        <Grid item>
                            <div className='flex gap-[5px]'>
                                <Button variant='outlined' size='large' onClick={() => location.reload()}>
                                    Refresh
                                </Button>

                                <Button variant='contained' size='large' onClick={() => this.props.router.back()}>
                                    Kembali
                                </Button>
                            </div>
                        </Grid>
